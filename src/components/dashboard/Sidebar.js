  ...
  return (
    ...
    <aside className="w-72 bg-[#111c5a] text-white flex flex-col shadow-xl">
      ...
      <div className="p-4 border-t border-white/10 space-y-2">
        ...
        <button className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-white/70 hover:bg-white/5 hover:text-white transition-all duration-200 cursor-pointer">
